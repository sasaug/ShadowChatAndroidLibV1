...
public class ShadowMessageQueue extends ProtectedFile {
    ...
    public ShadowMessageQueue(KeyChain keyChain, String path){
    ...
    private void load(){
        try {
            ...
            LogUtil.debug("Queue", queue.size() + " messages loaded into queue.");
            LogUtil.debug("Queue", unsent.size() + " messages loaded into unsent.");
